...
function calculateSmile(likelihood){
    setElementValue("smileValue", (likelihood > 0.5));
}
//entry point :
function main(){
        ...
        { //mouth. Inside a group each expression is an exclusive choice
          ...
          */
          ...
          svgSmileLeft: function(ks){
              setElementValue("smileLeft", ks.smileLeft);
              return ks.smileLeft-ks.smileRight;
          },

          svgSmileRight: function(ks){
              setElementValue("smileRight", ks.smileRight);
              return ks.smileRight-ks.smileLeft;
          },

          svgSmile: function(ks){
              calculateSmile(ks.smileRight+ks.smileLeft);
             return (ks.smileRight+ks.smileLeft);
          }
        },
